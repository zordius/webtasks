...
contextCached = function (task, args) {
    var taskKey = task.taskType + '_' + task.taskName + ':' + Array.prototype.slice.call(arguments).join(','),
...
webtaskContextProto = {
    ...
    input: function (name) {
        return locate(this, name, 'input').apply(this, []);
    },
    data: function (name) {
        return subtask.before(locate(this, name, 'data'), contextCached);
    },
    module: function (name) {
        return subtask.after(locate(this, name, 'module'), contextRender);
    },
    page: function (name) {
        return subtask.after(locate(this, name, 'page'), contextRender);
    },
    react: function (name) {
